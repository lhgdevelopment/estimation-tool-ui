...
export default function ProjectsComponentsComponent() {
  return (
    <>
      <Box className='container grid px-6 mx-auto'>
        <Box component={'h3'} className='my-4 text-lg font-semibold text-gray-600 dark:text-gray-300'>
          Project Components
        </Box>
                ...
                <tr className='text-gray-700 dark:text-gray-400'>
                  <td className='px-4 py-3'>
                    <Box className='flex items-center text-sm'>
                      ...
                      <Box className='relative hidden w-8 h-8 mr-3 rounded-full md:block'>
                        <img
                          ...
                          loading='lazy'
                        />
                        <Box className='absolute inset-0 rounded-full shadow-inner' aria-hidden='true'></Box>
                      </Box>
                      <Box>
