...
import { TProblemsAndGoalsComponent } from '../ProblemsAndGoals.decorator'

export default function ProblemsAndGoalsFormComponent(props: TProblemsAndGoalsComponent) {
