      ...
      <Box className='container px-6 mx-auto'>
        ...
        <Box className='grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4'>
          ...
          <Box className='flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800'>
            ...
            <Box>
              <Box component={'p'} className='mb-2 text-sm font-medium text-gray-600 dark:text-gray-400'>
                New Entries this Week
              </Box>
              <Box component={'p'} className='text-lg font-semibold text-gray-700 dark:text-gray-200'>
                3
              </Box>
            </Box>
          </Box>
